...
helpMessage =""" Dark Knight SelfBot MENU
...
🛡[Steal Home @] 
  ...
  🛡SUPPORT BY:
  🛡SHOS(SingHeartOfSoul) 
  🛡d'Crescendo
  🛡CYBER CRIME BOT PROTECT
...
staff = ["u787d28e13bd4f94cdca5457cd90efaf4"]
adminMID = ["u787d28e13bd4f94cdca5457cd90efaf4"]
wait = {
    'protect':False,
    'protectinv':False,
    'protectqr':False,
    ...
    try:
        if op.param1 in wait2['readPoint']:
            ...
            if Name in wait2['readMember'][op.param1]:
                ...
                wait2['ROM'][op.param1][op.param2] = "ツ1�71ￄ1�77" + Name
        else:
            cl.sendText
    except:
        pass
...
#-----------------------------------------------
        if op.type == 17:
                ...
                cl.sendText(op.param1, "Selamat Datang kaka.. Salken ya, jgn nakal ya, klo nakal tak cipok")
                print "MEMBER HAS JOIN THE GROUP"

        if op.type == 15:
                if op.param2 in Bots:
                     return
                cl.sendText(op.param1, "Papay kaka.. Jgn lupa jln pulang ya ka 😝..")
...
#-----------------------------------------------
               ...
               if msg.from_ in admin:
                ...
                kk.sendText(msg.to, "Ok 􀨁􀄻double thumbs up")
                kc.sendText(msg.to,"Ok 􀨁􀄻double thumbs up")
                kd.sendText(msg.to,"Ok 􀨁􀄻double thumbs up")
                ke.sendText(msg.to,"Ok 􀨁􀄻double thumbs up")
                kf.sendText(msg.to,"Ok 􀨁􀄻double thumbs up")
#-----------------------------------------------
            elif "Bc " in msg.text:
                if msg.from_ in admin:
...
def autolike():
    ...
    if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try: 
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by: ArkaLee http://line.me/ti/p/nYpnIWZs69")
